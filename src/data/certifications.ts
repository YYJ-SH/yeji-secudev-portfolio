export const certifications = {
    ko: {
      certifications: {
        title: "자격증 & 교육 이수",
        subtitle: "전문성을 입증하는 자격과 교육 이수 과정",
        certificates: [
          // ✅ 자격증 (Certifications)
          {
            name: "리눅스마스터 2급",
          ...
          {
            name: "인공지능을 활용한 휴먼 포즈 제네레이션 시스템 개발",
            issuer: "플레이데이터평생교육원",
