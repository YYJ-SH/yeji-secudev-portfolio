  ...
  return (
    <div className="p-6">
      <div className="relative group">
        ...
        <Card className="relative border-2 border-purple-300/50 bg-gradient-to-b from-gray-50 to-white/80 backdrop-blur-sm
          ...
          <div className="p-6">
            ...
            <div className="mb-8 space-y-4">
              <div className="flex items-start justify-between">
                <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-cyan-600 
                             text-transparent bg-clip-text">{project.title}</h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-purple-600">
                        ...
                        <span>Duration: {project.duration || project.period}</span>
                      </div>
                    </div>
